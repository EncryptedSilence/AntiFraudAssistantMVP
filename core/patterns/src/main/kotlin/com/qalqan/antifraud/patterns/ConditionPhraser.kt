...
internal object ConditionPhraser {
    fun phrase(condition: PatternCondition): String =
    ...
    private fun phraseCall(c: PatternCondition): String =
        when (c.field) {
    ...
    private fun phraseSms(c: PatternCondition): String =
        when (c.field) {
            "containsCode" ->
                if (c.value == true) {
                    "An SMS with a verification code arrived."
                } else {
                    "SMS without code condition matched."
                }
            "containsLink" ->
    ...
    private fun phraseWeb(c: PatternCondition): String =
        when (c.field) {
    ...
    private fun phraseAnswer(c: PatternCondition): String =
        when (c.field) {
