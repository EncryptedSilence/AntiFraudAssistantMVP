...
/**
 * Spec §23 #31 — on a dual-SIM device, SMS arriving on either SIM produces an SmsEvent
 * with the correct simSlot.
 */
...
class Acceptance31MultiSimSmsTest {
    ...
    @Test
    fun `subscription 1 maps to simSlot 0 and subscription 2 maps to simSlot 1`() {
