...
object SmsKeywordDetector {
    ...
    private val FINANCIAL_TERMS: List<String> = listOf(
        // KZ Russian
    ...
    private val SECURITY_TERMS: List<String> = listOf(
        // KZ Russian
    ...
    fun containsFinancialKeyword(body: String): Boolean =
        FINANCIAL_TERMS.any { body.contains(it, ignoreCase = true) }

    fun containsSecurityKeyword(body: String): Boolean =
        SECURITY_TERMS.any { body.contains(it, ignoreCase = true) }

    fun isAuthorityShortCode(rawSender: String): Boolean =
        rawSender.trim() in AUTHORITY_SHORT_CODES
