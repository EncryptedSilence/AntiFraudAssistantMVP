...
- `Codex-api` is the only bundled tech-aware skill, and it does **not** apply here — `§2.1` forbids any AI integration.
...
- Project permissions: `.Codex/settings.json` (tracked), `.Codex/settings.local.json` (user-local, not tracked).
